        ...
        2)
                ...
                while true; do
                    ...
                    if [ "${col_types[0]}" == "int" ]; then
                        if ! [[ "$pk_val" =~ ^-?[0-9]+$ ]]; then
                            ...
                            echo -e "${RED}Primary key must be positive!${NC}"
                            continue
                        fi
                    fi
            ...
            2)
                ...
                while true; do
                    ...
                    if [ -z "$matched" ]; then
                        echo -e "${RED}No matched records found for $col = $val${NC}"
                    else
                        echo -e "${CYAN}"
            ...
            3)
                while true; do
                    ...
                    if [ -z "$col1" ] || [ -z "$col2" ] || [ -z "$val1" ] || [ -z "$val2" ]; then
                        echo -e "${RED}Columns and values cannot be empty!${NC}"
                        continue
                    fi
                    ...
                    if [ -z "$matched" ]; then
                        echo -e "${RED}No matched records found for $col1 = $val1 AND $col2 = $val2${NC}"
                    else
                        echo -e "${CYAN}"
        ...
        3)
            ...
            1)
                while true; do
                    ...
                    col=$(echo "$col" | xargs)
                    if [ -z "$col" ]; then
                        echo -e "${RED}Column cannot be empty!${NC}"
                        continue
                    fi
            ...
            2)
                while true; do
                    ...
                    if [ -z "$cols" ]; then
                        echo -e "${RED}Columns cannot be empty!${NC}"
                        continue
                    fi
                    ...
                    for c in $cols; do
                        ...
                        if [ $found -eq -1 ]; then
                            echo -e "${RED}Column $c not found!${NC}"
                            continue 2
                        fi
                        col_indices+=($found)
                    done
